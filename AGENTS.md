...
This repository is a portfolio project for a memory-first, evidence-grounded, evaluation-driven Career Agent.
...
Do not reposition this project as a generic resume generator, auto-apply bot, or job board.
...
After TypeScript, router, eval, memory, opportunity, or provider changes, run as applicable:
